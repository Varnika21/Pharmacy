...
public class Bill {
	...
	public void CreateInvoice(ArrayList<Cart> c, String usrname, ArrayList<DataBase> db) throws IOException {
		String address = null;
		String name = null;
		String email = null;
		long phnno = 0;
		...
		for (DataBase d1 : db) {
			if (d1.usrname.equals(usrname)) {
				// System.out.println(d1.usrname + d1.address);
				address = d1.address;
				email = d1.email;
				phnno = d1.phnno;
				name = d1.name;
		...
		System.out.println("-------------------------------------------------------------");
		String path;
		path = "C:\\Users\\pnisc\\OneDrive\\Desktop\\" + usrname + ".txt";
