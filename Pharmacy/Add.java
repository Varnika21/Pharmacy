...
import PharmacyExceptions.MedicineNotFoundException;
import PharmacyExceptions.MedicineQuantityExceeded;
	...
	public void check_availability() throws Exception {
		...
		for (medicine m : set) {
			if (m.tablet.equalsIgnoreCase(name)) {
				...
				// countmed1++;
				// System.out.println(countmed1 + " " + countmed);
				String choice;
				flag = 1;
